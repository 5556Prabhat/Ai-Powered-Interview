...
import { Eye, EyeOff, Mail, Lock, User, Terminal, ArrowRight } from 'lucide-react';
...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-6 py-12">
            ...
            <div className="absolute top-1/3 left-1/4 w-96 h-96 bg-[#D97706]/10 rounded-full blur-3xl" />
            <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-[#FBBF24]/10 rounded-full blur-3xl" />
            ...
            >
                ...
                <div className="glass-card p-8">
                    <h2 className="text-2xl font-bold text-center mb-2 text-[#E5E7EB]">Create Account</h2>
                    <p className="text-[#9CA3AF] text-center mb-8">Start your journey to interview mastery</p>
                    ...
                    <p className="text-center text-[#9CA3AF] mt-6 text-sm">
                        ...
                        <Link href="/auth/login" className="text-accent hover:text-[#F59E0B] font-medium">
                            Sign in
                        </Link>
                    </p>
                </div>
